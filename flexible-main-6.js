var mql = window.matchMedia('screen and (min-width: 604px)');if (mql.matches){var boxArray=["css-menu"];window.addEventListener("mouseup",function(e){for(var r=0;r<boxArray.length;r++){var o=document.getElementById(boxArray[r]);e.target!=o&&e.target.parentNode!=o&&(o.style.left="-250px")}});
}
