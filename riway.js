...
$(function(){ // document ready
   if ($('#sidebar-wrapper').length) { // make sure "#sticky" element exists
      var el = $('#sidebar-wrapper');
      var stickyTop = $('#sidebar-wrapper').offset().top; // returns number
      var stickyHeight = $('#sidebar-wrapper').height();

      $(window).scroll(function(){ // scroll event
          var limit = $('#templatemo-sticky').offset().top - stickyHeight - 20;
...
function showChatforum() {
var o = document.getElementById("collapseChatforum");
var e=document.getElementById("collapseChatadmin");
o.style.position = "relative";o.style.opacity = "1";o.style.height = "100%";e.style.display = "none";
};
function hideChatforum() {
var o = document.getElementById("collapseChatforum");
o.style.position = "fixed";o.style.opacity = "0";o.style.height = "0";
};

function showChatadmin(){var e=document.getElementById("collapseChatadmin");"block"!==e.style.display?e.style.display="block":e.style.display="none";var o = document.getElementById("collapseChatforum");o.style.position = "fixed";o.style.opacity = "0";o.style.height = "0";};
